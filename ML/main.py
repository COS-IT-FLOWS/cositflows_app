...
from model import LSTM_Model, LSTM_BI_Model
...
def LSTM_run_model(Preprocessing, Postprocessing, model_index):
...
def LSTM_BI_run_model(Preprocessing, Postprocessing, model_index):
...
def main():
    with multiprocessing.get_context('spawn').Pool(4) as executor:
        executor.starmap(LSTM_BI_run_model, [(Preprocessing,Postprocessing, 'model_1'), (Preprocessing, Postprocessing, 'model_2')])
